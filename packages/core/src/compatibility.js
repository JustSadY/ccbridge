const BUILTIN_CONTRACTS = {
  ...
  "qwen-code": { contractVersion: 1, sourceFormats: ["qwen-code/session-jsonl"], recordKinds: ["record:user", "record:assistant", "record:tool_result", "record:system", "malformed-json"], recordKindPrefixes: ["record:system:"], contentTypes: ["text", "tool-call", "tool-result", "reasoning", "attachment"], preserveUnknownRecords: true, openSourceStorageContract: true, treeStructured: true, compressionAware: true, subagentTranscripts: true, testedVersions: [] },
